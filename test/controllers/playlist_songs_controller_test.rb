...
class PlaylistSongsControllerTest < ActionController::TestCase
  ...
  test "should create playlist_song" do
    assert_difference('PlaylistSong.count') do
      post :create, playlist_song: { playlist_id: @playlist_song.playlist_id, rank: @playlist_song.rank, song_id: @playlist_song.song_id }
    end
  ...
  test "should update playlist_song" do
    patch :update, id: @playlist_song, playlist_song: { playlist_id: @playlist_song.playlist_id, rank: @playlist_song.rank, song_id: @playlist_song.song_id }
    assert_redirected_to playlist_song_path(assigns(:playlist_song))
  end
